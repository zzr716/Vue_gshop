<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="toogleShopShow">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="tooglesupportShow">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="shopShow">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="toogleShopShow">
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="supportShow">
        <div class="activity-sheet-content">
          ...
          <div class="activity-sheet-close" @click="tooglesupportShow">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
